...
class ManagersDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox'  , 'admin.managers.btn.checkbox')
            ->addColumn('edit'      , 'admin.managers.btn.edit')
            ->addColumn('delete'    , 'admin.managers.btn.delete')
            ->addColumn('img'       , 'admin.managers.btn.img')
            ->addColumn('active'    , 'admin.managers.btn.active')
            ->rawColumns([
                'edit',
                'delete' ,
                'checkbox' ,
    ...
    {
        return Manager::orderBy('id','desc')->get();
    }
    ...
    {
        return 'ManagersDataTable' . date('YmdHis');
    }
}
