...
class ReservationsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox'  , 'admin.reservations.btn.checkbox')
            ->addColumn('delete'    , 'admin.reservations.btn.delete')
            ->addColumn('show'      , 'admin.reservations.btn.show')
            ->addColumn('doctor'    , 'admin.reservations.btn.doctor')
            ->rawColumns([
                'delete' ,
                'checkbox' ,
                'show' ,
    ...
    {
        return 'ReservationsDataTable' . date('YmdHis');
    }
}
