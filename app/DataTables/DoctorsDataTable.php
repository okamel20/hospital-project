...
class DoctorsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            ->addColumn('img'       , 'admin.doctors.btn.img')
            ->addColumn('section'   , 'admin.doctors.btn.section')
            ->addColumn('active'    , 'admin.doctors.btn.active')
            ->rawColumns([
                'edit',
                'delete' ,
                'checkbox' ,
    ...
    {
        return 'DoctorsDataTable' . date('YmdHis');
    }
}
