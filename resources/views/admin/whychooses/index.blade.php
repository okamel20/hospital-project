...
<div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header card-header-primary">
          <div class="row">
            ...
            <div class="col-md-4">
              <button type="button" class="btn btn-white btn-round add" style="float: @if(lang() == 'ar' ) left @else right @endif">{{ trans('admin.addData')}}
              </button>
  ...
  <div class="widget-footer">
    ...
    <div class="alert alert-success col-lg-12 itemActive ">
      <div class="row">
        <div class="col-md-10">
          {{ trans('admin.yesItemActive') }} <span class="yesItemActive"> </span>
        </div>
        <div class="col-md-2 ">
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    $('.sendActive').on('click',function(){ 
      $('.form').prop('action','{{adminUrl('whychooses/active/all')}}');
      setTimeout(function(){
            $('#form_active').submit();
      }, 500);
    });
    ...
    {
      $('.form').prop('action','{{adminUrl('whychooses/destroy/all')}}');
      setTimeout(function(){
            $('#form_active').submit();
      }, 500);
