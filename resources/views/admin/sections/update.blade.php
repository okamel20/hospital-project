    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
              {!! Form::open(['url'=>adminUrl('sections/'.$data->id),'method'=>'put','files'=>true]) !!}

                <div class="col-lg-12">
                  <label> القسم عربى  </label>
                  <input type="text" name="name_ar" class="form-control" placeholder="القسم عربى " required value="{{ oldOrValue('name_ar',$data) }}">
                </div>
                <div class="col-lg-12">
                  <label> القسم انجليزى  </label>
                  <input type="text" name="name_en" class="form-control" placeholder="القسم انجليزى " required value="{{ oldOrValue('name_en',$data) }}">
                </div>
