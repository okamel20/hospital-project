...
<!--   Core JS Files   -->
  ...
  <script src="<?php echo e(url('/public/dark/')); ?>/js/core/jquery.min.js"></script>
  <script src="<?php echo e(url('/public/dark/')); ?>/js/core/popper.min.js"></script>
  <script src="<?php echo e(url('/public/dark/')); ?>/js/core/bootstrap-material-design.min.js"></script>
  <script src="https://unpkg.com/default-passive-events"></script>
  <script src="<?php echo e(url('/public/dark/')); ?>/js/plugins/perfect-scrollbar.jquery.min.js"></script>
  <!-- Place this tag in your head or just before your close body tag. -->
  <script async defer src="https://buttons.github.io/buttons.js"></script>
  <!--  Google Maps Plugin    -->
  
  <!-- Chartist JS -->
  <script src="<?php echo e(url('/public/dark/')); ?>/js/plugins/chartist.min.js"></script>
  <!--  Notifications Plugin    -->
  <script src="<?php echo e(url('/public/dark/')); ?>/js/plugins/bootstrap-notify.js"></script>
  <!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="<?php echo e(url('/public/dark/')); ?>/js/material-dashboard.js?v=2.1.0"></script>
  <!-- Material Dashboard DEMO methods, don't include it in your project! -->
  <script src="<?php echo e(url('/public/dark/')); ?>/demo/demo.js"></script>
  <!-- Slimscroll JS -->
