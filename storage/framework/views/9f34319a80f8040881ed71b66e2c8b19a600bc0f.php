...
<body class="simple-page" style="background-image: url(<?php echo e(url('/public/')); ?>/section-back.jpg);background-size: cover;width: 150%;top: 0;left: 0;position: absolute;">
            ...
            <div class="simple-page-wrap col-md-12" >
                ...
                <div class="simple-page-form animated flipInY" id="login-form">
                    ...
                    <form  method="post" action="<?php echo e(adminUrl('login')); ?>">
                        ...
                        <input type="submit" class="btn btn-info" value="<?php echo e(trans('admin.signIn')); ?>">
                    </form>
                </div>
